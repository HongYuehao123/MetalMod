...
- **The lightmap pass is verified, including the std140 padding of its uniform block.**
  `core/lightmap` turns a texture coordinate into a block level and a sky level and colours the texel
